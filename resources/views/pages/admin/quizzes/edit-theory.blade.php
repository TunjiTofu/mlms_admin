        ...
        <div class="content-right">
            ...
            <div class="app-file-area">
                ...
                <div class="app-file-content">
                    <h6 class="font-weight-700 mb-1">Edit {{ $quizDetails->title }} (Theory Question)</h6>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <form class="row mt-1" id="myForm" method="POST"
                                    action="{{ route('quizzes-theoryupdate', ['id' => $singleTheoryDetails->id]) }}">
                                    @csrf
                                    {{ method_field('PATCH') }}
                                    <div class="row mb-2">
                                        <div class="col s12">
                                        ...
                                        <div class="col s6">
                                            <div class="input-field col s12">
                                                <input id="score" type="number" name="score"
                                                    class="validate" required value="{{ $singleTheoryDetails->score }}">
                                                ...
                                                <select name="status" id="status" class="select2 browser-default">
                                                    ...
                                                    @foreach (json_decode($responseStatus) as $status)
                                                        <option value="{{ $status->id }}"
                                                            {{ $status->id == $singleTheoryDetails->status ? 'selected = "selected"' : '' }}>
                                                            {{ $status->status }}
                                                        </option>
                                                    @endforeach
                                                </select>
