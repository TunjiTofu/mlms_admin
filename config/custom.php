...
return [
    'custom' => [
        ...
        'navbarLarge' => false, //options:[boolean]:true or false default(true)
        'navbarBgColor' => 'blue darken-2', //Options: cyan,teal,light-blue,amber (any of materializecolor class can be pass). warning:if isNavbarDark set NavbarBgColor not work.
        ...
        'activeMenuColor' => 'blue lighten-3', //Sidebar active menu color (any of materializecolor class can be pass)
        ...
        'isFooterDark' => false, //True for dark, flase for light and null for default
